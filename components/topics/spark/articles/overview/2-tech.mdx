...
比如说一个典型的WordCount程序，Spark只需要三行，而且非常容易理解。(作为对比，可以看看[Hadoop的WordCount](https://hadoop.apache.org/docs/stable/hadoop-mapreduce-client/hadoop-mapreduce-client-core/MapReduceTutorial.html#Source_Code))
